...
CIMGUI_API void igGetKeyChordName(ImGuiModFlags mods,ImGuiKey key,char* out_buf,int out_buf_size)
{
    return ImGui::GetKeyChordName(mods,key,out_buf,out_buf_size);
}
...
CIMGUI_API bool igIsKeyPressedEx(ImGuiKey key,ImGuiInputFlags flags)
{
    return ImGui::IsKeyPressedEx(key,flags);
}
